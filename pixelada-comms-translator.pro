######################################################################
  ...
  # modified manually by the pixelada-comms-translator project
######################################################################
...
#HEADERS += rldefine.h
HEADERS += pvapp.h 
HEADERS += pixeladaCT.h
HEADERS += qtdatabase.h
HEADERS += commDaemon.h
HEADERS += pctDatabase.h
HEADERS += pctTable.h
HEADERS += pctTriggersTable.h
HEADERS += pctDataTable.h
HEADERS += pctSlave.h
HEADERS += iniConfigurator.h
HEADERS += config.h
HEADERS += readThread.h
HEADERS += lib/pugixml-1.7/src/pugixml.hpp
HEADERS += lib/pugixml-1.7/src/pugiconfig.hpp

SOURCES += main.cpp 
SOURCES += pixeladaCT.cpp
SOURCES += qtdatabase.cpp
SOURCES += commDaemon.cpp
SOURCES += pctDatabase.cpp
SOURCES += pctTable.cpp
SOURCES += pctTriggersTable.cpp
SOURCES += pctDataTable.cpp
SOURCES += pctSlave.cpp
SOURCES += iniConfigurator.cpp
SOURCES += config.cpp
SOURCES += readThread.cpp
...
unix:LIBS         += ./lib/gStools/libgStools.so
#
